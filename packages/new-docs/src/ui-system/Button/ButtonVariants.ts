...
export const variants = tv({
  ...
  variants: {
    variant: {
      primary: ['bg-primary', 'hover:bg-primary/90', 'text-primary-foreground', 'fill-primary-foreground'],
      secondary: ['bg-secondary', 'hover:bg-secondary/90', 'text-secondary-foreground', 'fill-secondary-foreground'],
