...
It is a package (currently `@composify/react`) you install directly in your project. It bridges the gap between visual manipulation and your codebase.
...
If you're evaluating visual editors, you've likely looked at Builder.io, Puck or Plasmic. Here is how Composify compares architecturally:

| Feature | Puck | Builder.io | Plasmic | Composify |
| ------- | ---- | ---------- | ------- | --------- |
| **Source of Truth** | JSON | JSON | Proprietary Format | **JSX** |
| **Integration** | Requires Adaptation | Requires Adaptation | Requires Adaptation | **Zero Rewrite** |
