...
export const BlockActions = () => {
  const { duplicateActiveBlock, removeActiveBlock } = useEditing();

  return (
    <div className={getClassName()}>
      <button className={getClassName('ActionItem')} onClick={duplicateActiveBlock}>
      ...
      <button className={getClassName('ActionItem')} onClick={removeActiveBlock}>
        <svg xmlns="http://www.w3.org/2000/svg" width={16} height={16} viewBox="0 0 640 640">
