...
export const ViewportControl: FC<Props> = ({ viewports, onClick }) => (
  <div className={getClassName('ViewportList')}>
    {viewports ? (
      ...
      <>
        <button type="button" className={getClassName('ViewportItem')} onClick={() => onClick(375)}>
        ...
        <button type="button" className={getClassName('ViewportItem')} onClick={() => onClick(768)}>
        ...
        <button type="button" className={getClassName('ViewportItem')} onClick={() => onClick(1024)}>
