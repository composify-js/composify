...
export const ViewportControl: FC<Props> = ({ viewports, onClick }) => (
  <div className={getClassName('ViewportList')}>
    {viewports ? (
      viewports.map(viewport => (
        <button key={viewport.width} className={getClassName('ViewportItem')} onClick={() => onClick(viewport.width)}>
          {viewport.icon}
        </button>
      ))
    ) : (
      <>
        <button className={getClassName('ViewportItem')} onClick={() => onClick(375)}>
        ...
        <button className={getClassName('ViewportItem')} onClick={() => onClick(768)}>
        ...
        <button className={getClassName('ViewportItem')} onClick={() => onClick(1024)}>
